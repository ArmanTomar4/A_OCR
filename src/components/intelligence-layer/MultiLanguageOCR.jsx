...
const MULTI_LANGUAGE_OCR_STYLES = `
  ...
  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(1) {
  ...
  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(2) {
    transform: translateY(0px);
    stroke-width: 2;
    stroke: #fff;
    stroke-opacity: 1;
    animation: wave 2s infinite 0.2s;
  }

  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(3) {
    transform: translateY(-10px);
    stroke-width: 2;
    stroke: #fff;
    stroke-opacity: 1;
  ...
  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(4) {
  ...
  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(5) {
    transform: translateY(5px);
    stroke-width: 2;
    stroke: #fff;
    stroke-opacity: 1;
  ...
  .multi-language-ocr-card:hover .multi-language-ocr-svg path:nth-child(6) {
    transform: translateY(0px);
    stroke-width: 2;
    stroke: #fff;
    stroke-opacity: 1;
  ...
  return (
    <div className="multi-language-ocr-card">
      ...
      <p className="multi-language-ocr-description">
        SUPPORTS 100+ LANGUAGES WITH AUTOMATIC TRANSLATION CAPABILITIES FOR GLOBAL DOCUMENT PROCESSING.
      </p>
    </div>
  );
} 